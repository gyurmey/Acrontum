   ...
   const  onClick = () => {
    ...
    return (
        <div className="container">
            ...
            <button type="button" class="btn btn-info" onClick={onClick}>Operator</button>
            ...
            <div className="park-level-three-three">
             ...
             <br/>
                ...
                {slots && counter.includes(108) ? ( <span style={{"backgroundColor":"green"}} className="item"></span>) : (<span className="item"></span>)}
